    ...
    function handleTh(
        ...
        switch (type) {
            case "name":
                ...
                break;
            case "email":
                results = originalUsers.sort((a, b) =>
        ...
        <div className="">
            ...
            <form onSubmit={handleSearchSubmit} onReset={handleSearchSubmit}>
                <input
                    ...
                    autoComplete="off"
                />
                <button type="submit" className="btn btn-success btn-sm rounded-l-xl w-24 ml-4">
                    Rechercher
                </button>
                <button type="reset" className="btn btn-error btn-sm rounded-r-xl w-24">
                    Annuler
                </button>
            </form>
            <table className="table table-xs mt-4">
                <thead>
                    <tr>
                        <th>Id</th>
                        <th className="hover:cursor-pointer" onClick={(e) => handleTh(e, "name")}>
                            Nom Discord
                        </th>
                        <th className="hover:cursor-pointer" onClick={(e) => handleTh(e, "email")}>
                            Email
                        </th>
                        <th className="hover:cursor-pointer" onClick={(e) => handleTh(e, "number")}>
                            Matricule
                        </th>
                        <th
                        ...
                        <th className="hover:cursor-pointer" onClick={(e) => handleTh(e, "rank")}>
                            Grade
                        </th>
                        <th className="hover:cursor-pointer" onClick={(e) => handleTh(e, "role")}>
                            Role
                        </th>
                        <th>Est désactivé</th>
                    </tr>
